...
namespace Engine
{
	...
	enum BUFFERID { BUFFER_TRICOL, BUFFER_RCTEX, BUFFER_TERRAINTEX, BUFFER_CUBETEX, BUFFER_COLLSPHERE, BUFFER_PTTEX, BUFFER_INRCTEX };
	...
	enum MESHTYPE		{ TYPE_STATIC, TYPE_DYNAMIC, TYPE_NAVI, TYPE_ARROWNAVI };
