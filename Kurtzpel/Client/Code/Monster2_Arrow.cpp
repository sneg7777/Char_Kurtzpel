...
CMonster2_Arrow::CMonster2_Arrow(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUnit(pGraphicDev)
{
...
CMonster2_Arrow::~CMonster2_Arrow(void)
{

}

HRESULT Client::CMonster2_Arrow::Add_Component(void)
{
	Engine::CComponent*		pComponent = nullptr;
	
	CUnit::Add_Component();
	// Mesh
	pComponent = m_sComponent.m_pStaticMeshCom = dynamic_cast<Engine::CStaticMesh*>(Engine::Clone(Engine::RESOURCE_STAGE, L"Mesh_Monster2_CrossBowArrow"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
	m_mapComponent[Engine::ID_STATIC].emplace(L"Com_Mesh", pComponent);


	//m_pTransformCom->m_vInfo[Engine::INFO_POS] = { 5.f, -15.f, 10.f };
	m_sComponent.m_pTransformCom->m_vScale = { 0.07f, 0.07f, 0.07f };

	return S_OK;
}


CMonster2_Arrow* CMonster2_Arrow::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CMonster2_Arrow*	pInstance = new CMonster2_Arrow(pGraphicDev);
...
void CMonster2_Arrow::Free(void)
{
	Engine::CGameObject::Free();
}


HRESULT Client::CMonster2_Arrow::Ready_Object(void)
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);

	return S_OK;
}
Client::_int Client::CMonster2_Arrow::Update_Object(const _float& fTimeDelta)
{
...
void Client::CMonster2_Arrow::Render_Object(void)
{
...
HRESULT Client::CMonster2_Arrow::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
void Client::CMonster2_Arrow::Collision(CSphereCollider* _mySphere, CUnit* _col, CSphereCollider* _colSphere, const _float& fTimeDelta)
{
...
void Client::CMonster2_Arrow::Create_Coll()
{
	CSphereCollider* sphereCol = CSphereCollider::Create(m_pGraphicDev);
	sphereCol->Set_Transform(1.4f);
...
void Client::CMonster2_Arrow::Set_SpeedToLife(float _speed, float _life)
{
